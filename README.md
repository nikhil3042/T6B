...
## Element Handling
- Detailed examples and practice exercises which are also explained are provided in the **`robot_exercises`** folder.

## API Testing with Robot Framework
- API automation content is available in:
  - **`Api_robot`** folder (practical implementation)
  - **`api_testing_notes.pdf`** (theoretical concepts and explanations)
